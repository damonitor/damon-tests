...
#
# [1] https://lore.kernel.org/202602221352.odZW8x1R-lkp@intel.com
...
cd $linux_root
make "O=${out_dir}" ARCH=m68k allyesconfig

export COMPILER_INSTALL_PATH=$HOME/0day
export COMPILER=gcc-15.2.0

make.cross "O=${out_dir}" ARCH=m68k olddefconfig
make.cross "O=${out_dir}" ARCH=m68k W=1 SHELL=/bin/bash mm/damon/
exit $?
